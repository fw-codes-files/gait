...
class Realtime(object):
    ...
    def start(cls):
        ...
        while key&0xFF !=27:
            ...
            ret = mc.get()
            for i in range(32):
                j0[i] = np.array([ret[0][2].joints[i].position.x,ret[0][2].joints[i].position.y,ret[0][2].joints[i].position.z])
                j1[i] = np.array([ret[1][2].joints[i].position.x,ret[1][2].joints[i].position.y,ret[2][2].joints[i].position.z])
                j2[i] = np.array([ret[2][2].joints[i].position.x,ret[2][2].joints[i].position.y,ret[2][2].joints[i].position.z])
            ...
            for i in range(uv1.shape[1]):
                u = int(uv1[0, i])
                v = int(uv1[1, i])
                cv2.circle(ret[0][1], (u,v), 2, (0, 255, 0), 2)
                lines.append((u,v))
            cv2.line(ret[0][1],lines[0],lines[1],(0,255,0))
            cv2.line(ret[0][1],lines[1],lines[2],(0,255,0))
            cv2.line(ret[0][1],lines[2],lines[3],(0,255,0))
            cv2.line(ret[0][1],lines[2],lines[4],(0,255,0))
            cv2.line(ret[0][1],lines[4],lines[5],(0,255,0))
            cv2.line(ret[0][1],lines[5],lines[6],(0,255,0))
            cv2.line(ret[0][1],lines[6],lines[7],(0,255,0))
            cv2.line(ret[0][1],lines[2],lines[8],(0,255,0))
            cv2.line(ret[0][1],lines[8],lines[9],(0,255,0))
            cv2.line(ret[0][1],lines[9],lines[10],(0,255,0))
            cv2.line(ret[0][1],lines[10],lines[11],(0,255,0))
            cv2.line(ret[0][1],lines[0],lines[12],(0,255,0))
            cv2.line(ret[0][1],lines[12],lines[13],(0,255,0))
            cv2.line(ret[0][1],lines[13],lines[14],(0,255,0))
            cv2.line(ret[0][1],lines[14],lines[15],(0,255,0))
            cv2.line(ret[0][1],lines[0],lines[16],(0,255,0))
            cv2.line(ret[0][1],lines[16],lines[17],(0,255,0))
            cv2.line(ret[0][1],lines[17],lines[18],(0,255,0))
            cv2.line(ret[0][1],lines[18],lines[19],(0,255,0))
            cv2.line(ret[0][1],lines[3],lines[20],(0,255,0))
